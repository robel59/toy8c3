...
from .models import Service, Content, Image, Quote, CodeBlock, Video, Order, Ad, List, Title, Subtitle, BlogContent, Comment
...
class BlogSerializer12(serializers.ModelSerializer):
    contents = ContentSerializer(many=True, read_only=True)
    blog_contents = BlogContentSerializer(many=True, read_only=True)
    print("3333333")
    print(blog_contents.data)
    class Meta:
        model = Service
        fields = '__all__'
