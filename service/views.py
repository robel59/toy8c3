...
from .serializers import BlogSerializer, OrderSerializer, ContentSerializer, ImageSerializer, QuoteSerializer, CodeBlockSerializer, VideoSerializer, AdSerializer, ListSerializer, TitleSerializer, SubtitleSerializer
...
def register_order(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return render(request, 'order_form.html', {'form': OrderForm(), 'success_message': 'Order completed successfully.'})
    else:
        form = OrderForm()
